...
BvbiBvbGQgdGVsZXR5cGVzLgo=,
    ...
    chunks = [
        ...
        bytes.fromhex(""),
        bytes.fromhex(""),
        AsyncAPDU(
            data=bytes.fromhex(
...
def test_sign_function_call_binary_hexdump_after_utf8_error(firmware, backend, navigator: Navigator, test_name):
    """
...
Dx8vP09fb3+Pn6+/z9/g==,
    ...
    chunks = [
        ...
        bytes.fromhex(""),
        AsyncAPDU(
            data=bytes.fromhex(
