...
def test_sign_batch_transaction_all_actions(firmware, backend, navigator: Navigator, test_name):
    ...
    chunks = [
        ...
        bytes.fromhex(""),
        AsyncAPDU(
            data=bytes.fromhex(
        ...
        bytes.fromhex(""),
        bytes.fromhex(""),
        AsyncAPDU(
            data=bytes.fromhex(
        ...
        bytes.fromhex(""),
        AsyncAPDU(
            data=bytes.fromhex(
